...
class AuthViewModel (val authRepository: AuthRepository, val authPreferences: AuthPreferences) : ViewModel() {
    ...
    fun googleLogin(googleId: String, pref: SharedPreferences) {
        viewModelScope.launch {
    ...
    fun login(email: String, password: String, pref: SharedPreferences) {
        viewModelScope.launch {
            _authState.value = AuthState.Loading
            try {
    ...
    fun register(email: String, password: String, pref: SharedPreferences) {
        viewModelScope.launch {
            _authState.value = AuthState.Loading
            try {
